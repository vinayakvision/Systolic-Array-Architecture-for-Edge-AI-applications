...
# Generated on: Fri Apr 17 23:17:09 IST 2026 (Fri Apr 17 17:47:09 UTC 2026)
...
set_log_file logs_Apr17-23:13:33/rtl2intermediate.lec.log -replace
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl/pe.v
delete_search_path -all -design -golden
add_search_path ../rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl/sram.v
delete_search_path -all -design -golden
add_search_path ../rtl -design -golden
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -verilog2k  ../rtl/systolic_array.v
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles logs_Apr17-23:13:33/rtl2intermediate.lec.log
}
